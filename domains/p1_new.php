...
$xml = simplexml_load_file("http://timesofindia.feedsportal.com/c/33039/f/533919/index.rss");
	...
	//		echo $c->getName() . ": " . $c . "<br />";
		   ...
		   {	
			...
			if($x != "" && $arr[1] != "" && $arr[2] != "" && $p != 0) {
				$arr[2]=str_replace( "GMT", "+0000", $arr[2] );
				echo $arr[2];
				echo "<br />";
				//$old_date=date('');
				...
				$sql="INSERT INTO news_story(uid,title,link,date) VALUES($p,'$x','$arr[1]','$arr[2]')";
