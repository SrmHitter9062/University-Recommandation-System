...
if (!isset($_SESSION['email_id'])) {
        header('Location: http://localhost/NRS/success_login.php');
}
...
$cur = strtotime($cur);
mysql_query("UPDATE user_behaviour SET india= india+1 WHERE email_id= '$email_id'");
...
?>
    ...
    <div id="templatemo_footer">
    	Copyright © 2013 <a href="http://www.iiita.ac.in">Indian Institute of Information Technology, Allahabad</a>
    </div>
</div>
