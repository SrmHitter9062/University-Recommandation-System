...
if (!isset($_SESSION['email_id'])) {
        header('Location: http://localhost/project1/success_login.php');
}
...
$result1 = mysql_query("select count(cnt) from user_interest where email_id ='$user' and title ='$tit'");
...
if ($count1 == 0)
{
	echo $cur1;
	echo "<br />";
	mysql_query("insert into user_interest values('$user','$tit','$c','national',1,'$cur1')");
}
else
{
	echo $cur1;
