...
$xml = simplexml_load_file("http://timesofindia.indiatimes.com/rssfeeds/4719161.cms");
	...
	//		echo $c->getName() . ": " . $c . "<br />";
		   ...
		   {	
			...
			if($x != "" && $arr[1] != "" && $arr[2] != "" && $p != 0) {
				...
				$sql="INSERT INTO news_story(uid,title,link,date,type_news,cnt) VALUES($p,'$x','$arr[1]','$arr[2]','cricket',0)";
