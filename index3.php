<?php header("refresh: 1800; url=http://localhost/NRS/index3.php"); ?>
<?php
	...
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				...
				<br>
				<p class="grey">This website is part of a Project work for Indian Institute of Information Technology, Allahabad!</p>
				<br><br>
				<p><font color='red'>Login Unsuccessful. Enter correct Username Password.</font></p>
			</div>
			<div class="left">
				<!-- Login Form -->
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
               <li><a href="nit1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				NITs</a></li>
                <li><a href="world1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				IITs</a></li>
                <li><a href="technical1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				IIITs</a></li>
                <li><a href="business1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				State Govt. Colleges</a></li>
                <li><a href="education1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				Private Colleges</a></li>
                <li><a href="science1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				Foreign Colleges</a></li>
				<li><a href="health1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				IIMS</a></li>
				<li><a href="entertainment1.php" onClick="alert('registered users login first.....register yourself if you are a new user');return false;">
				Entertainment</a></li>
