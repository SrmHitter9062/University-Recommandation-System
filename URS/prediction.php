<?php header("refresh: 1800; url=http://localhost/NRS/prediction.php"); ?>
<?php 
// Inialize session
session_start();
...
if (!isset($_SESSION['username'])) {
        ...
        header('Location: http://localhost/NRS/index1.php');
}
?>
<?php
...
echo " record added";
 //header( 'Location:http://localhost/NRS/index2.php' ) ;
