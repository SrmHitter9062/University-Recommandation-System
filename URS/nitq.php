<?php header("refresh: 1800; url=http://localhost/NRS/nitq.php"); ?>
<?php
		...
		while($row = mysql_fetch_array($result))
		  {
				  ...
				  $date = $row['date'];
					...
					echo "<a href='/NRS/rate.php?x=$link&t=$title2&z=$catagory' target=\"_blank\">Rate</a>";
				 
					//echo '<a href="/NRS/combo1.php">Give Rating</a>';
