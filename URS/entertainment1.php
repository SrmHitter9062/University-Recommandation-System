<?php header("refresh: 1800; url=http://localhost/NRS/entertainment1.php"); ?>
<?php
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">Medical colleges</div>
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'entertainmentq.php';?>
    ...
    <div id="templatemo_sidebar">
		...
		<li><a href="entertainment1.php"><font color='red'>Medical colleges</font></a></li>
