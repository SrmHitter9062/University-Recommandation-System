<?php header("refresh: 1800; url=http://localhost/NRS/technical1.php"); ?>
<?php
	...
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				...
				<br>
				<p class="grey">This website is part of a Project work for technicaln Institute of Information Technology, Allahabad!</p>
			</div>
			<div class="left">
				<!-- Login Form -->
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">IIITs</div>
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'technicalq.php';?>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="technical1.php"><font color='red'>IIITs</font></a></li>
