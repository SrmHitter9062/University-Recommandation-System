<?php header("refresh: 1800; url=http://localhost/NRS/science1.php"); ?>
<?php
	...
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				...
				<br>
				<p class="grey">This website is part of a Project work for sciencen Institute of Information Technology, Allahabad!</p>
			</div>
			<div class="left">
				<!-- Login Form -->
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">Foreign Colleges</div>
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'scienceq.php';?>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="science1.php"><font color='red'>Foreign Colleges</font></a></li>
    ...
    <div id="templatemo_footer">
    	Copyright © 2014 <a href="http://www.iiita.ac.in">IndianInstitute of Information Technology, Allahabad</a>
    </div>
</div>
