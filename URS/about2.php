...
<div id="templatemo_wrapper">
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
			...
			<!-- <li><a href="profile.php">Profile</a ></li> -->          		
              	<li><a href="about2.php" class="selected">About</a></li>
    ...
    <div id="content_top">
        <div id="page_title">Personalise Universities</div>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="world2.php">IITs</a></li>
                <li><a href="technical2.php">IIITs</a></li>
                <li><a href="business2.php">State Govt. Colleges</a></li>
                <li><a href="education2.php">Private Colleges</a></li>
                <li><a href="science2.php">Foreign Colleges</a></li>
		<li><a href="health2.php">IIMS</a></li>
		<li><a href="entertainment2.php">Medical colleges</a></li>
