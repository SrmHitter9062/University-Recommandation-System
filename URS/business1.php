<?php header("refresh: 1800; url=http://localhost/NRS/business1.php"); ?>
<?php
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">State Govt. Colleges</div>
        
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'businessq.php';?>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="business1.php"><font color='red'>State Govt. Colleges</font></a></li>
