...
<div id="toppanel">
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				<h1>Educational Guide System</h1>
				<br>
				<p class="grey">This Educational Guide system Project work for Indian Institute of Information Technology, Allahabad!</p>
			</div>
			<div class="left">
				<!-- Login Form -->
				<form method="POST" action="/NRS/login/loginproc.php">
					<h1>Member Login</h1>
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">Educational Guide</div>
...
<br><br><br>
        <p>With the rapid development of the World Wide Web, information on Web pages is rapidly inflated and congested with large amounts of universities contents.This website represents a system that aggregates universities from various distrubuted universities.The system organizes them according to <a>pre-defined universities categories</a> and constructs personalized views via a Web-based interface.</p>
        <ul class="templatemo_list">
        	<li>Relevance is decided by the users interested domain(s) submitted by the user himself and his click behavior.</li>
            <li>Adaptive personalization is performed, based on the individual user interaction, user similarities and statistical analysis of aggregate usage data.</li>
            <li>A user is also recommended the latest, most viewed universitied which are significant in spite of lesser click count.</li>
            <li>Use of RSS feeds is done to make the website dynamic.</li>
		</ul>
        <div class="cleaner h20"></div>
        <blockquote>In short a kind of personalized university is provided by us to user which is customized according to his interested domain.
        </blockquote>
    </div> <!-- end of content -->
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="world1.php">IITs</a></li>
                <li><a href="technical1.php">IIITs</a></li>
                <li><a href="business1.php">State Govt. Colleges</a></li>
                <li><a href="education1.php">Private Colleges</a></li>
                <li><a href="science1.php">Foreign Colleges</a></li>
		<li><a href="health1.php">IIMS</a></li>
		<li><a href="entertainment1.php">Medical colleges</a></li>
		<!--<li><a href="sports1.php">Sports</a></li>
		<li><a href="lifestyle1.php">Life Style</a></li> -->
			</ul>
        </div>
