<?php// header("refresh: 1800; url=http://localhost/NRS/try2.php"); ?>
<?php
...
?>
		...
		<?php
		$result = mysql_query("SELECT distinct title,link,type_news,date FROM news_story where cnt > 2 group by title order by date DESC");
