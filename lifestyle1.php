<?php header("refresh: 1800; url=http://localhost/NRS/lifestyle1.php"); ?>
<?php
	...
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				...
				<br>
				<p class="grey">This website is part of a Project work for lifestylen Institute of Information Technology, Allahabad!</p>
			</div>
			<div class="left">
				<!-- Login Form -->
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">Lifestyle</div>
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'lifestyleq.php';?>
