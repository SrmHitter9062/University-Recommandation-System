	...
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				...
				<br>
				<p class="grey">This Educational Guide System is Project work for Indian Institute of Information Technology, Allahabad!</p>
			</div>
			<div class="left">
				<!-- Login Form -->
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
           ...
           <li><a href="index1.php">Home</a></li>
              	...
              	<li><a href="contact1.php" class="selected">Contact</a></li>             </ul>
            <br style="clear: left" />
