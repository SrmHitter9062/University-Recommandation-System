`1<?php header("refresh: 1800; url=http://localhost/NRS/nit1.php"); ?>
<?php
...
<div id="templatemo_wrapper">
    ...
    <div id="content_top">
        <div id="page_title">NITs</div>
        <div class="cleaner"></div>
    </div>  
    
    <div id="templatemo_content">
    	<?php include 'nitq.php';?>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
        	<h2>Categories</h2>
            <ul class="sb_list">
            	<li><a href="nit1.php" ><font color='red'>NITs</font></a></li>
